...
const videos = [
  ...
  },
  {
    ...
    image: "src/assets/images/hero/mike-massimino.jpg",
    url: "https://player.vimeo.com/video/673758300?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479",
  },
  {
...
function VideoCard({ video }) {
  return (
    <div className="">
      <iframe src={video.url} frameborder="0" allowfullscreeen class="w-96 aspect-video"></iframe>
      <div className="bg-slate-800 w-96 px-3 py-2">
